...
class StrategyRunner:
    ...
    def __init__(self, config_yaml: str = 'elysian_core/config/config.yaml', 
        ...
        self.binance_kline_manager = _kline_client_manager
        self.binance_ob_manager = _ob_client_manager
    ...
    def setup_and_run_binance_feeds(self):
        ...
        asyncio.run(self._setup_data_feeds())
    ...
    async def run(self) -> None:
        ...
        try:
            ...
            with ProcessPoolExecutor(max_workers=4) as executor:
                ...
                # run_in_executor integrates properly with the async event loop
